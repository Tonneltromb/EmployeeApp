...
public class MainController {
    ...
    public int addEmployee(ContractEmployee contractEmployee) throws ParseException {
    ...
    public void editEmployee(ContractEmployee contractEmployee, @RequestParam int id) throws ParseException {
